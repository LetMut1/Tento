...
An alternative for Offset. Used only for requering. The value must be equal to the Name of the last Channel of Channel registry in
reseived early response.
```
