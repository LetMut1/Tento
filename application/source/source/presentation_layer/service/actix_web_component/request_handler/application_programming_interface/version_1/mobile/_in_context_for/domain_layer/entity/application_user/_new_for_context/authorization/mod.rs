...
impl Authorization {
    ...
    pub async fn pre_register(
        data: Data<AggregateConnectionPool>,
        form: ActixWebResult<Form<RequestPreRegister>>
    ) -> HttpResponse<Body> {
        match form {
            Ok(form_) => {
                if let Err(ref base_error) = HandlerPreRegister::handle(data.into_inner(), form_.into_inner()) {
                    match base_error {
    ...
    pub async fn register(
        data: Data<AggregateConnectionPool>,
        form: ActixWebResult<Form<RequestRegister>>
    ) -> HttpResponse<Body> {
        match form {
            Ok(form_) => {
                match HandlerRegister::handle(data.into_inner(), form_.into_inner()) {
                    Ok(response) => { 
                        return StandardResponseCreator::wrap_for_success_with_body_and_create_ok(response);
                    },
                    Err(ref base_error) => {
    ...
    pub async fn pre_log_in(
        data: Data<AggregateConnectionPool>,
        form: ActixWebResult<Form<RequestPreLogIn>>
    ) -> HttpResponse<Body> {
        match form {
            Ok(form_) => {
                match HandlerPreLogIn::handle(data.into_inner(), form_.into_inner()) {
                    Ok(response) => { 
                        return StandardResponseCreator::wrap_for_success_with_body_and_create_ok(response); 
                    },
                    Err(ref base_error) => {
    ...
    pub async fn log_in(
        data: Data<AggregateConnectionPool>,
        form: ActixWebResult<Form<RequestLogIn>>
    ) -> HttpResponse<Body> {
        match form {
            Ok(form_) => {
                match HandlerLogIn::handle(data.into_inner(), form_.into_inner()) {
                    Ok(response) => { 
                        return StandardResponseCreator::wrap_for_success_with_body_and_create_ok(response); 
                    },
                    Err(ref base_error) => {
