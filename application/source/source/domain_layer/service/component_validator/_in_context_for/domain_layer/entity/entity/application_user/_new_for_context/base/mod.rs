...
impl Base {
    ...
    pub fn is_valid_email<'outer_a>(email: &'outer_a str) -> Result<bool, BaseError> {
        return Ok(
    ...
    pub fn is_valid_nickname<'outer_a>(nickname: &'outer_a str) -> bool {
        return nickname.chars().count() <= (Self::NICKNAME_MAXIMUM_LENGTH as usize);
    }

    pub fn is_valid_password<'outer_a>(password: &'outer_a str) -> bool {
