...
impl<'outer_a> JsonAccessWebToken<'outer_a> {
    ...
    pub fn get_alg<'this>(&'this self) -> &'this str {
        return self.header.get_alg();
    }

    pub fn get_typ<'this>(&'this self) -> &'this str {
        return self.header.get_typ();
    }

    pub fn get_id<'this>(&'this self) -> &'this str {
    ...
    pub fn get_application_user_log_in_token_device_id<'this>(&'this self) -> &'this str {
        return self.payload.get_application_user_log_in_token_device_id();
    }

    pub fn get_exp<'this>(&'this self) -> &'this str {
