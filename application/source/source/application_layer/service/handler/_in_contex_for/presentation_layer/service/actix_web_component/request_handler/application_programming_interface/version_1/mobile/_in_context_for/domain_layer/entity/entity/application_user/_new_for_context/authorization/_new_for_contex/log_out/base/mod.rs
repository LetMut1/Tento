...
impl Base {
    pub fn handle<'outer_a>(
        ...
        if let Some(json_refresh_web_token) = RepositoryProxy::get_by_application_user_id_and_application_user_log_in_token_device_id(
        ...
        )?
        {
            ...
            StateManagerJsonAccessWebTokenBlackListRedis::create(connection, &JsonAccessWebTokenBlackList::new(json_access_web_token.get_id()))?;
