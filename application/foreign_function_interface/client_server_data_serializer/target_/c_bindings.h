...
typedef struct CUnifiedReport_CVoid__ChannelPublication1Mark_Delete_Precedent {
  struct CData_CVoid target;
  struct ChannelPublication1Mark_Delete_Precedent precedent;
  bool is_target;
} CUnifiedReport_CVoid__ChannelPublication1Mark_Delete_Precedent;

typedef struct CResult_CUnifiedReport_CVoid__ChannelPublication1Mark_Delete_Precedent {
  struct CUnifiedReport_CVoid__ChannelPublication1Mark_Delete_Precedent data;
  bool is_data;
} CResult_CUnifiedReport_CVoid__ChannelPublication1Mark_Delete_Precedent;

typedef struct CResult_CUnifiedReport_CVoid__ChannelPublication1Mark_Delete_Precedent ChannelPublication1Mark_Delete_CResult;
...
typedef struct CUnifiedReport_CVoid__ChannelPublication1View_Create_Precedent {
  struct CData_CVoid target;
  struct ChannelPublication1View_Create_Precedent precedent;
  bool is_target;
} CUnifiedReport_CVoid__ChannelPublication1View_Create_Precedent;

typedef struct CResult_CUnifiedReport_CVoid__ChannelPublication1View_Create_Precedent {
  struct CUnifiedReport_CVoid__ChannelPublication1View_Create_Precedent data;
  bool is_data;
} CResult_CUnifiedReport_CVoid__ChannelPublication1View_Create_Precedent;

typedef struct CResult_CUnifiedReport_CVoid__ChannelPublication1View_Create_Precedent ChannelPublication1View_Create_CResult;
...
typedef struct CData_ChannelPublication1Commentary_Create_Outcoming {
  struct ChannelPublication1Commentary_Create_Outcoming filled;
  bool is_filled;
} CData_ChannelPublication1Commentary_Create_Outcoming;
...
typedef struct CUnifiedReport_ChannelPublication1Commentary_Create_Outcoming__ChannelPublication1Commentary_Create_Precedent {
  struct CData_ChannelPublication1Commentary_Create_Outcoming target;
  struct ChannelPublication1Commentary_Create_Precedent precedent;
  bool is_target;
} CUnifiedReport_ChannelPublication1Commentary_Create_Outcoming__ChannelPublication1Commentary_Create_Precedent;

typedef struct CResult_CUnifiedReport_ChannelPublication1Commentary_Create_Outcoming__ChannelPublication1Commentary_Create_Precedent {
  struct CUnifiedReport_ChannelPublication1Commentary_Create_Outcoming__ChannelPublication1Commentary_Create_Precedent data;
  bool is_data;
} CResult_CUnifiedReport_ChannelPublication1Commentary_Create_Outcoming__ChannelPublication1Commentary_Create_Precedent;

typedef struct CResult_CUnifiedReport_ChannelPublication1Commentary_Create_Outcoming__ChannelPublication1Commentary_Create_Precedent ChannelPublication1Commentary_Create_CResult;
...
typedef struct CUnifiedReport_CVoid__ChannelPublication1Commentary_Delete_Precedent {
  struct CData_CVoid target;
  struct ChannelPublication1Commentary_Delete_Precedent precedent;
  bool is_target;
} CUnifiedReport_CVoid__ChannelPublication1Commentary_Delete_Precedent;

typedef struct CResult_CUnifiedReport_CVoid__ChannelPublication1Commentary_Delete_Precedent {
  struct CUnifiedReport_CVoid__ChannelPublication1Commentary_Delete_Precedent data;
  bool is_data;
} CResult_CUnifiedReport_CVoid__ChannelPublication1Commentary_Delete_Precedent;

typedef struct CResult_CUnifiedReport_CVoid__ChannelPublication1Commentary_Delete_Precedent ChannelPublication1Commentary_Delete_CResult;
...
struct CResult_CVector_c_uchar channel_publication1_mark__delete__serialize_allocate(struct ChannelPublication1Mark_Delete_Incoming incoming);

void channel_publication1_mark__delete__serialize_deallocate(struct CResult_CVector_c_uchar c_result);

ChannelPublication1Mark_Delete_CResult channel_publication1_mark__delete__deserialize_allocate(struct CVector_c_uchar c_vector_of_bytes);

void channel_publication1_mark__delete__deserialize_deallocate(ChannelPublication1Mark_Delete_CResult _c_result);

struct CResult_CVector_c_uchar channel_publication1_view__create__serialize_allocate(struct ChannelPublication1View_Create_Incoming incoming);

void channel_publication1_view__create__serialize_deallocate(struct CResult_CVector_c_uchar c_result);

ChannelPublication1View_Create_CResult channel_publication1_view__create__deserialize_allocate(struct CVector_c_uchar c_vector_of_bytes);

void channel_publication1_view__create__deserialize_deallocate(ChannelPublication1View_Create_CResult _c_result);

struct CResult_CVector_c_uchar channel_publication1_commentary__create__serialize_allocate(struct ChannelPublication1Commentary_Create_Incoming incoming);

void channel_publication1_commentary__create__serialize_deallocate(struct CResult_CVector_c_uchar c_result);

ChannelPublication1Commentary_Create_CResult channel_publication1_commentary__create__deserialize_allocate(struct CVector_c_uchar c_vector_of_bytes);

void channel_publication1_commentary__create__deserialize_deallocate(ChannelPublication1Commentary_Create_CResult _c_result);

struct CResult_CVector_c_uchar channel_publication1_commentary__delete__serialize_allocate(struct ChannelPublication1Commentary_Delete_Incoming incoming);

void channel_publication1_commentary__delete__serialize_deallocate(struct CResult_CVector_c_uchar c_result);

ChannelPublication1Commentary_Delete_CResult channel_publication1_commentary__delete__deserialize_allocate(struct CVector_c_uchar c_vector_of_bytes);

void channel_publication1_commentary__delete__deserialize_deallocate(ChannelPublication1Commentary_Delete_CResult _c_result);
