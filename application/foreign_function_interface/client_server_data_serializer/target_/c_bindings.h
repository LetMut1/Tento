...
typedef struct ChannelPublication1MarkedView_CreateMark_Incoming_ {
  struct UserAccessTokenSigned_ user_access_token_signed;
  struct ChannelTokenSigned_ channel_token_signed;
  struct ChannelPublication1TokenSigned_ channel_publication1_token_signed;
} ChannelPublication1MarkedView_CreateMark_Incoming_;

typedef struct ChannelPublication1MarkedView_CreateMark_Precedent_ {
  bool user_access_token___already_expired;
  bool channel_token___already_expired;
  bool channel_publication1_token___already_expired;
...
typedef struct UnifiedReport__Void___ChannelPublication1MarkedView_CreateMark_Precedent_ {
  struct Data__Void_ target;
  struct ChannelPublication1MarkedView_CreateMark_Precedent_ precedent;
  bool is_target;
} UnifiedReport__Void___ChannelPublication1MarkedView_CreateMark_Precedent_;

typedef struct Result__UnifiedReport__Void___ChannelPublication1MarkedView_CreateMark_Precedent_ {
  struct UnifiedReport__Void___ChannelPublication1MarkedView_CreateMark_Precedent_ data;
  bool is_data;
} Result__UnifiedReport__Void___ChannelPublication1MarkedView_CreateMark_Precedent_;

typedef struct Result__UnifiedReport__Void___ChannelPublication1MarkedView_CreateMark_Precedent_ ChannelPublication1MarkedView_CreateMark_Result;

typedef struct ChannelPublication1MarkedView_CreateView_Incoming_ {
  struct UserAccessTokenSigned_ user_access_token_signed;
  struct ChannelTokenSigned_ channel_token_signed;
  struct ChannelPublication1TokenSigned_ channel_publication1_token_signed;
} ChannelPublication1MarkedView_CreateView_Incoming_;

typedef struct ChannelPublication1MarkedView_CreateView_Precedent_ {
  bool user_access_token___already_expired;
  bool channel_token___already_expired;
  bool channel_publication1_token___already_expired;
} ChannelPublication1MarkedView_CreateView_Precedent_;

typedef struct UnifiedReport__Void___ChannelPublication1MarkedView_CreateView_Precedent_ {
  struct Data__Void_ target;
  struct ChannelPublication1MarkedView_CreateView_Precedent_ precedent;
  bool is_target;
} UnifiedReport__Void___ChannelPublication1MarkedView_CreateView_Precedent_;

typedef struct Result__UnifiedReport__Void___ChannelPublication1MarkedView_CreateView_Precedent_ {
  struct UnifiedReport__Void___ChannelPublication1MarkedView_CreateView_Precedent_ data;
  bool is_data;
} Result__UnifiedReport__Void___ChannelPublication1MarkedView_CreateView_Precedent_;

typedef struct Result__UnifiedReport__Void___ChannelPublication1MarkedView_CreateView_Precedent_ ChannelPublication1MarkedView_CreateView_Result;

typedef struct ChannelPublication1MarkedView_DeleteMark_Incoming_ {
  struct UserAccessTokenSigned_ user_access_token_signed;
  struct ChannelTokenSigned_ channel_token_signed;
  struct ChannelPublication1TokenSigned_ channel_publication1_token_signed;
} ChannelPublication1MarkedView_DeleteMark_Incoming_;

typedef struct ChannelPublication1MarkedView_DeleteMark_Precedent_ {
  bool user_access_token___already_expired;
  bool channel_token___already_expired;
  bool channel_publication1_token___already_expired;
...
typedef struct UnifiedReport__Void___ChannelPublication1MarkedView_DeleteMark_Precedent_ {
  struct Data__Void_ target;
  struct ChannelPublication1MarkedView_DeleteMark_Precedent_ precedent;
  bool is_target;
} UnifiedReport__Void___ChannelPublication1MarkedView_DeleteMark_Precedent_;

typedef struct Result__UnifiedReport__Void___ChannelPublication1MarkedView_DeleteMark_Precedent_ {
  struct UnifiedReport__Void___ChannelPublication1MarkedView_DeleteMark_Precedent_ data;
  bool is_data;
} Result__UnifiedReport__Void___ChannelPublication1MarkedView_DeleteMark_Precedent_;

typedef struct Result__UnifiedReport__Void___ChannelPublication1MarkedView_DeleteMark_Precedent_ ChannelPublication1MarkedView_DeleteMark_Result;
...
struct Result__Vec__c_uchar channel_publication1_marked_view__create_mark__serialize_allocate(struct ChannelPublication1MarkedView_CreateMark_Incoming_ incoming);

void channel_publication1_marked_view__create_mark__serialize_deallocate(struct Result__Vec__c_uchar result);

ChannelPublication1MarkedView_CreateMark_Result channel_publication1_marked_view__create_mark__deserialize_allocate(struct Vec__c_uchar vector_of_bytes);

void channel_publication1_marked_view__create_mark__deserialize_deallocate(ChannelPublication1MarkedView_CreateMark_Result _result);

struct Result__Vec__c_uchar channel_publication1_marked_view__create_view__serialize_allocate(struct ChannelPublication1MarkedView_CreateView_Incoming_ incoming);

void channel_publication1_marked_view__create_view__serialize_deallocate(struct Result__Vec__c_uchar result);

ChannelPublication1MarkedView_CreateView_Result channel_publication1_marked_view__create_view__deserialize_allocate(struct Vec__c_uchar vector_of_bytes);

void channel_publication1_marked_view__create_view__deserialize_deallocate(ChannelPublication1MarkedView_CreateView_Result _result);

struct Result__Vec__c_uchar channel_publication1_marked_view__delete_mark__serialize_allocate(struct ChannelPublication1MarkedView_DeleteMark_Incoming_ incoming);

void channel_publication1_marked_view__delete_mark__serialize_deallocate(struct Result__Vec__c_uchar result);

ChannelPublication1MarkedView_DeleteMark_Result channel_publication1_marked_view__delete_mark__deserialize_allocate(struct Vec__c_uchar vector_of_bytes);

void channel_publication1_marked_view__delete_mark__deserialize_deallocate(ChannelPublication1MarkedView_DeleteMark_Result _result);
