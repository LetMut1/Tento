...
use library::infrastructure_layer::service::handler::_in_context_for_binary::source::presentation_layer::web_main::_new_for_context::handler::Handler;
...
// TODO Do not remove this block until the problems have been fixed {
    // TODO Искусственная генерация UUID. Как считывать с удалением. Блокировки?
    ...
    // TODO  Пройтись по всем Unwrap() ( и второму аналогу)
