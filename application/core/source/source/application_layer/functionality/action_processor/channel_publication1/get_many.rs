            ...
            '_a: for row in rows.iter() {
                data_registry.push(
                    Data {
                        ...
                        channel_publication1__created_at: crate::result_return_logic!(row.try_get::<'_, usize, i64>(7)),
                        channel_publication1_mark__created_at: crate::result_return_logic!(row.try_get::<'_, usize, Option<i64>>(8)),
