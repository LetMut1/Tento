...
pub const TOKIO_CONFIGURATION_ERROR_MESSAGE_2: &'static str =
    "The vaule of 'system.tokio.worker_threads_quantity' is not equal to the quantity of elements in the value of 'system.tokio.affinited_cores'.";
