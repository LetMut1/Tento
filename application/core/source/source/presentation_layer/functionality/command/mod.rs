...
impl Command {
    pub fn process() -> Result<(), AggregateError> {
        ...
        const COMMAND_RESOLVE_INCOMPLITE_STATE: &'static str = "resolve_incomplite_state";
        ...
        let arg_matches = clap::command!()
            ...
            .subcommand(Command_::new(COMMAND_RESOLVE_INCOMPLITE_STATE))
            .get_matches();
        ...
        return match subcommand_arg_matches {
            ...
            (COMMAND_RESOLVE_INCOMPLITE_STATE, _) => CommandProcessor::<ResolveIncompliteState>::process(environment_configuration_file_path.as_str()),
