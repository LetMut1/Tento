...
CREATE UNIQUE INDEX user_registration_token_1 ON public.user_registration_token
...
ADD CONSTRAINT user_registration_token_2 UNIQUE USING INDEX user_registration_token_1;