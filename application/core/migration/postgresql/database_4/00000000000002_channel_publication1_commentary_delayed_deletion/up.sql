CREATE TABLE public.channel_publication1_commentary_delayed_deletion (
...
CREATE INDEX channel_publication1_commentary_delayed_deletion_1 ON public.channel_publication1_commentary_delayed_deletion
USING btree (can_be_deleted_from ASC NULLS LAST) WITH (fillfactor = 90, deduplicate_items = on);

ALTER TABLE ONLY public.channel_publication1_commentary_delayed_deletion
