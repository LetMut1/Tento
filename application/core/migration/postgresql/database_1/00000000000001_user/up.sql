...
USING btree (obfuscated_id ASC NULLS LAST) WITH (fillfactor = 85, deduplicate_items = on);
...
CREATE UNIQUE INDEX user__5 ON public.user_
USING btree (nickname ASC NULLS LAST) WITH (fillfactor = 90, deduplicate_items = on);

ALTER TABLE ONLY public.user_
ALTER COLUMN id SET NOT NULL,
ALTER COLUMN obfuscated_id SET NOT NULL,
ALTER COLUMN email SET NOT NULL,
ALTER COLUMN nickname SET NOT NULL,
ALTER COLUMN password_hash SET NOT NULL,
ALTER COLUMN created_at SET NOT NULL,
ADD CONSTRAINT user__6 UNIQUE USING INDEX user__2,
ADD CONSTRAINT user__7 UNIQUE USING INDEX user__3,
ADD CONSTRAINT user__8 UNIQUE USING INDEX user__4,
ADD CONSTRAINT user__9 UNIQUE USING INDEX user__5,