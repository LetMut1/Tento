...
struct ApplicationUser__Authorization___AuthorizeByLastStep___Incoming {
  long application_user_id;
  C_String application_user_device_id;
  C_String application_user_authorization_token_value;
};
...
struct ApplicationUser__Authorization___CheckEmailForExisting___Incoming {
  C_String application_user_email;
};
...
struct ApplicationUser__Authorization___CheckNicknameForExisting___Incoming {
  C_String application_user_nickname;
};
...
struct ApplicationUser__Authorization___DeauthorizeFromAllDevices___Incoming {
  C_String application_user_access_token_encrypted;
};
...
struct ApplicationUser__Authorization___DeauthorizeFromOneDevice___Incoming {
  C_String application_user_access_token_encrypted;
};
...
struct ApplicationUser__Authorization___RefreshAccessToken___Incoming {
  C_String application_user_access_token_encrypted;
  C_String application_user_access_refresh_token_encrypted;
};
...
struct ApplicationUser__Authorization___RegisterByFirstStep___Incoming {
  C_String application_user_email;
  C_String application_user_device_id;
};
...
struct ApplicationUser__Authorization___RegisterBySecondStep___Incoming {
  C_String application_user_email;
  C_String application_user_device_id;
  C_String application_user_registration_token_value;
};
...
struct ApplicationUser__Authorization___RegisterByLastStep___Incoming {
  C_String application_user_device_id;
  C_String application_user_nickname;
  C_String application_user_password;
  C_String application_user_email;
...
struct ApplicationUser__Authorization___ResetPasswordByFirstStep___Incoming {
  C_String application_user_email;
  C_String application_user_device_id;
};
...
struct ApplicationUser__Authorization___ResetPasswordBySecondStep___Incoming {
  long application_user_id;
  C_String application_user_device_id;
  C_String application_user_reset_password_token_value;
};
...
struct ApplicationUser__Authorization___ResetPasswordByLastStep___Incoming {
  long application_user_id;
  C_String application_user_device_id;
  C_String application_user_password;
  C_String application_user_reset_password_token_value;
...
struct ApplicationUser__Authorization___SendEmailForRegister___Incoming {
  C_String application_user_email;
  C_String application_user_device_id;
};
...
struct ApplicationUser__Authorization___SendEmailForAuthorize___Incoming {
  C_String application_user_device_id;
  long application_user_id;
};
...
struct ApplicationUser__Authorization___SendEmailForResetPassword___Incoming {
  long application_user_id;
  C_String application_user_device_id;
};
...
struct Channel__Base___GetManyByNameInSubscriptions___Incoming {
  C_String application_user_access_token_encrypted;
  C_String channel_name;
  C_Option<C_String> requery_channel_name;
  short limit;
};
...
struct Channel__Base___GetManyBySubscription___Incoming {
  C_String application_user_access_token_encrypted;
  C_Option<long> requery_channel_id;
  short limit;
};
...
struct Channel__Base___GetManyPublicByName___Incoming {
  C_String application_user_access_token_encrypted;
  C_String channel_name;
  C_Option<C_String> requery_channel_name;
  short limit;
...
struct Channel__Base___GetOneById___Incoming {
  C_String application_user_access_token_encrypted;
  long channel_id;
};
...
struct ChannelSubscription__Base___Create___Incoming {
  C_String application_user_access_token_encrypted;
  long channel_id;
};
...
void application_user___authorization____authorize_by_first_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____authorize_by_last_step____serialize(ApplicationUser__Authorization___AuthorizeByLastStep___Incoming *incoming);

void application_user___authorization____authorize_by_last_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____check_email_for_existing____serialize(ApplicationUser__Authorization___CheckEmailForExisting___Incoming *incoming);

void application_user___authorization____check_email_for_existing____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____check_nickname_for_existing____serialize(ApplicationUser__Authorization___CheckNicknameForExisting___Incoming *incoming);

void application_user___authorization____check_nickname_for_existing____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____deauthorize_from_all_devices____serialize(ApplicationUser__Authorization___DeauthorizeFromAllDevices___Incoming *incoming);

void application_user___authorization____deauthorize_from_all_devices____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____deauthorize_from_one_device____serialize(ApplicationUser__Authorization___DeauthorizeFromOneDevice___Incoming *incoming);

void application_user___authorization____deauthorize_from_one_device____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____refresh_access_token____serialize(ApplicationUser__Authorization___RefreshAccessToken___Incoming *incoming);

void application_user___authorization____refresh_access_token____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____register_by_first_step____serialize(ApplicationUser__Authorization___RegisterByFirstStep___Incoming *incoming);

void application_user___authorization____register_by_first_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____register_by_second_step____serialize(ApplicationUser__Authorization___RegisterBySecondStep___Incoming *incoming);

void application_user___authorization____register_by_second_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____register_by_last_step____serialize(ApplicationUser__Authorization___RegisterByLastStep___Incoming *incoming);

void application_user___authorization____register_by_last_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____reset_password_by_first_step____serialize(ApplicationUser__Authorization___ResetPasswordByFirstStep___Incoming *incoming);

void application_user___authorization____reset_password_by_first_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____reset_password_by_second_step____serialize(ApplicationUser__Authorization___ResetPasswordBySecondStep___Incoming *incoming);

void application_user___authorization____reset_password_by_second_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____reset_password_by_last_step____serialize(ApplicationUser__Authorization___ResetPasswordByLastStep___Incoming *incoming);

void application_user___authorization____reset_password_by_last_step____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____send_email_for_register____serialize(ApplicationUser__Authorization___SendEmailForRegister___Incoming *incoming);

void application_user___authorization____send_email_for_register____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____send_email_for_authorize____serialize(ApplicationUser__Authorization___SendEmailForAuthorize___Incoming *incoming);

void application_user___authorization____send_email_for_authorize____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *application_user___authorization____send_email_for_reset_password____serialize(ApplicationUser__Authorization___SendEmailForResetPassword___Incoming *incoming);

void application_user___authorization____send_email_for_reset_password____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *channel___base____get_many_by_name_in_subscriptions____serialize(Channel__Base___GetManyByNameInSubscriptions___Incoming *incoming);

void channel___base____get_many_by_name_in_subscriptions____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *channel___base____get_many_by_subscription____serialize(Channel__Base___GetManyBySubscription___Incoming *incoming);

void channel___base____get_many_by_subscription____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *channel___base____get_many_public_by_name____serialize(Channel__Base___GetManyPublicByName___Incoming *incoming);

void channel___base____get_many_public_by_name____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *channel___base____get_one_by_id____serialize(Channel__Base___GetOneById___Incoming *incoming);

void channel___base____get_one_by_id____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
...
C_Result<C_Vector<unsigned char>> *channel_subscription___base____create____serialize(ChannelSubscription__Base___Create___Incoming *incoming);

void channel_subscription___base____create____serialize____deallocate(C_Result<C_Vector<unsigned char>> *c_result);
