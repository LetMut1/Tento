...
result=`cp ./../../../target/aarch64-apple-ios/release/liblevel_2.a ./target_/aarch64-apple-ios/liblevel_2.a`
if [ $? != 0 ];
then
    echo "An error was occured: \n $result ."
    exit 1
fi
result=`cp ./../../../target/aarch64-apple-ios-sim/release/liblevel_2.a ./target_/aarch64-apple-ios-sim/liblevel_2.a`
if [ $? != 0 ];
then
    echo "An error was occured: \n $result ."
    exit 1
fi
result=`cp ./../../../target/x86_64-apple-ios/release/liblevel_2.a ./target_/x86_64-apple-ios/liblevel_2.a`
if [ $? != 0 ];
then
    echo "An error was occured: \n $result ."
    exit 1
