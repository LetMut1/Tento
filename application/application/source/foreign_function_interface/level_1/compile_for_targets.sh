...
result=`cp ./../../../target/aarch64-apple-ios/release/liblevel_1.a ./target_/aarch64-apple-ios/liblevel_1.a`
if [ $? != 0 ];
then
    echo "An error was occured: \n $result ."
    exit 1
fi
result=`cp ./../../../target/aarch64-apple-ios-sim/release/liblevel_1.a ./target_/aarch64-apple-ios-sim/liblevel_1.a`
if [ $? != 0 ];
then
    echo "An error was occured: \n $result ."
    exit 1
