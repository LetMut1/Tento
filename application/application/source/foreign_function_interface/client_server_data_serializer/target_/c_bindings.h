...
typedef struct ApplicationUserAccessRefreshTokenEncrypted {
...
typedef struct ApplicationUser__Authorization___AuthorizeByLastStep___Outcoming {
  ...
  struct ApplicationUserAccessRefreshTokenEncrypted application_user_access_refresh_token_encrypted;
