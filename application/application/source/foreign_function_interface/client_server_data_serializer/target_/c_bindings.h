...
ApplicationUser__Authorization___AuthorizeByFirstStep___C_Result *application_user___authorization____authorize_by_first_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___AuthorizeByLastStep___C_Result *application_user___authorization____authorize_by_last_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___CheckEmailForExisting___C_Result *application_user___authorization____check_email_for_existing____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___CheckNicknameForExisting___C_Result *application_user___authorization____check_nickname_for_existing____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___DeauthorizeFromAllDevices___C_Result *application_user___authorization____deauthorize_from_all_devices____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___DeauthorizeFromOneDevice___C_Result *application_user___authorization____deauthorize_from_one_device____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___RefreshAccessToken___C_Result *application_user___authorization____refresh_access_token____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___RegisterByFirstStep___C_Result *application_user___authorization____register_by_first_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___RegisterBySecondStep___C_Result *application_user___authorization____register_by_second_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___RegisterByLastStep___C_Result *application_user___authorization____register_by_last_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___ResetPasswordByFirstStep___C_Result *application_user___authorization____reset_password_by_first_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___ResetPasswordBySecondStep___C_Result *application_user___authorization____reset_password_by_second_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___ResetPasswordByLastStep___C_Result *application_user___authorization____reset_password_by_last_step____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___SendEmailForRegister___C_Result *application_user___authorization____send_email_for_register____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___SendEmailForAuthorize___C_Result *application_user___authorization____send_email_for_authorize____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ApplicationUser__Authorization___SendEmailForResetPassword___C_Result *application_user___authorization____send_email_for_reset_password____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
Channel__Base___GetManyByNameInSubscriptions___C_Result *channel___base____get_many_by_name_in_subscriptions____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
Channel__Base___GetManyBySubscription___C_Result *channel___base____get_many_by_subscription____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
Channel__Base___GetManyPublicByName___C_Result *channel___base____get_many_public_by_name____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
Channel__Base___GetOneById___C_Result *channel___base____get_one_by_id____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
...
ChannelSubscription__Base___Create___C_Result *channel_subscription___base____create____deserialize____allocate(struct C_Vector_c_uchar *vector_of_bytes);
