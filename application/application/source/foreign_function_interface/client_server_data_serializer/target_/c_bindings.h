...
typedef struct ApplicationUserAccessTokenEncoded {
  struct C_Vector_c_uchar serialized;
  struct C_Vector_c_uchar encoded;
} ApplicationUserAccessTokenEncoded;

typedef struct ApplicationUserAccessRefreshTokenEncoded {
...
typedef struct ApplicationUser__Authorization___AuthorizeByLastStep___Outcoming {
  struct ApplicationUserAccessTokenEncoded application_user_access_token_encoded;
  struct ApplicationUserAccessRefreshTokenEncoded application_user_access_refresh_token_encoded;
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____authorize_by_first_step____serialize____allocate(struct ApplicationUser__Authorization___AuthorizeByFirstStep___Incoming *incoming);
...
ApplicationUser__Authorization___AuthorizeByFirstStep___C_Result *application_user___authorization____authorize_by_first_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____authorize_by_last_step____serialize____allocate(struct ApplicationUser__Authorization___AuthorizeByLastStep___Incoming *incoming);
...
ApplicationUser__Authorization___AuthorizeByLastStep___C_Result *application_user___authorization____authorize_by_last_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____check_email_for_existing____serialize____allocate(struct ApplicationUser__Authorization___CheckEmailForExisting___Incoming *incoming);
...
ApplicationUser__Authorization___CheckEmailForExisting___C_Result *application_user___authorization____check_email_for_existing____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____check_nickname_for_existing____serialize____allocate(struct ApplicationUser__Authorization___CheckNicknameForExisting___Incoming *incoming);
...
ApplicationUser__Authorization___CheckNicknameForExisting___C_Result *application_user___authorization____check_nickname_for_existing____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____deauthorize_from_all_devices____serialize____allocate(struct ApplicationUser__Authorization___DeauthorizeFromAllDevices___Incoming *incoming);
...
ApplicationUser__Authorization___DeauthorizeFromAllDevices___C_Result *application_user___authorization____deauthorize_from_all_devices____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____deauthorize_from_one_device____serialize____allocate(struct ApplicationUser__Authorization___DeauthorizeFromOneDevice___Incoming *incoming);
...
ApplicationUser__Authorization___DeauthorizeFromOneDevice___C_Result *application_user___authorization____deauthorize_from_one_device____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____refresh_access_token____serialize____allocate(struct ApplicationUser__Authorization___RefreshAccessToken___Incoming *incoming);
...
ApplicationUser__Authorization___RefreshAccessToken___C_Result *application_user___authorization____refresh_access_token____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____register_by_first_step____serialize____allocate(struct ApplicationUser__Authorization___RegisterByFirstStep___Incoming *incoming);
...
ApplicationUser__Authorization___RegisterByFirstStep___C_Result *application_user___authorization____register_by_first_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____register_by_second_step____serialize____allocate(struct ApplicationUser__Authorization___RegisterBySecondStep___Incoming *incoming);
...
ApplicationUser__Authorization___RegisterBySecondStep___C_Result *application_user___authorization____register_by_second_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____register_by_last_step____serialize____allocate(struct ApplicationUser__Authorization___RegisterByLastStep___Incoming *incoming);
...
ApplicationUser__Authorization___RegisterByLastStep___C_Result *application_user___authorization____register_by_last_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____reset_password_by_first_step____serialize____allocate(struct ApplicationUser__Authorization___ResetPasswordByFirstStep___Incoming *incoming);
...
ApplicationUser__Authorization___ResetPasswordByFirstStep___C_Result *application_user___authorization____reset_password_by_first_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____reset_password_by_second_step____serialize____allocate(struct ApplicationUser__Authorization___ResetPasswordBySecondStep___Incoming *incoming);
...
ApplicationUser__Authorization___ResetPasswordBySecondStep___C_Result *application_user___authorization____reset_password_by_second_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____reset_password_by_last_step____serialize____allocate(struct ApplicationUser__Authorization___ResetPasswordByLastStep___Incoming *incoming);
...
ApplicationUser__Authorization___ResetPasswordByLastStep___C_Result *application_user___authorization____reset_password_by_last_step____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____send_email_for_register____serialize____allocate(struct ApplicationUser__Authorization___SendEmailForRegister___Incoming *incoming);
...
ApplicationUser__Authorization___SendEmailForRegister___C_Result *application_user___authorization____send_email_for_register____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____send_email_for_authorize____serialize____allocate(struct ApplicationUser__Authorization___SendEmailForAuthorize___Incoming *incoming);
...
ApplicationUser__Authorization___SendEmailForAuthorize___C_Result *application_user___authorization____send_email_for_authorize____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
...
struct C_Result_C_Vector_c_uchar *application_user___authorization____send_email_for_reset_password____serialize____allocate(struct ApplicationUser__Authorization___SendEmailForResetPassword___Incoming *incoming);
...
ApplicationUser__Authorization___SendEmailForResetPassword___C_Result *application_user___authorization____send_email_for_reset_password____deserialize____allocate(struct C_Vector_c_uchar *c_vector_of_bytes);
