...
using ApplicationUser__Authorization___CheckNicknameForExisting___Result = Result<UnifiedReport<ApplicationUser__Authorization___CheckNicknameForExisting___Outcoming, Void>>;
...
using ApplicationUser__Authorization___DeauthorizeFromAllDevices___Result = Result<UnifiedReport<Void, ApplicationUser__Authorization___DeauthorizeFromAllDevices___Precedent>>;
...
using ApplicationUser__Authorization___DeauthorizeFromOneDevice___Result = Result<UnifiedReport<Void, ApplicationUser__Authorization___DeauthorizeFromOneDevice___Precedent>>;
...
using ApplicationUser__Authorization___RefreshAccessToken___Result = Result<UnifiedReport<ApplicationUser__Authorization___RefreshAccessToken___Outcoming, ApplicationUser__Authorization___RefreshAccessToken___Precedent>>;
...
using ApplicationUser__Authorization___RegisterByFirstStep___Result = Result<UnifiedReport<ApplicationUser__Authorization___RegisterByFirstStep___Outcoming, ApplicationUser__Authorization___RegisterByFirstStep___Precedent>>;
...
using ApplicationUser__Authorization___RegisterBySecondStep___Result = Result<UnifiedReport<Void, ApplicationUser__Authorization___RegisterBySecondStep___Precedent>>;
...
using ApplicationUser__Authorization___RegisterByLastStep___Result = Result<UnifiedReport<ApplicationUser__Authorization___RegisterByLastStep___Outcoming, ApplicationUser__Authorization___RegisterByLastStep___Precedent>>;
...
using ApplicationUser__Authorization___ResetPasswordByFirstStep___Result = Result<UnifiedReport<ApplicationUser__Authorization___ResetPasswordByFirstStep___Outcoming, ApplicationUser__Authorization___ResetPasswordByFirstStep___Precedent>>;
...
using ApplicationUser__Authorization___ResetPasswordBySecondStep___Result = Result<UnifiedReport<Void, ApplicationUser__Authorization___ResetPasswordBySecondStep___Precedent>>;
...
using ApplicationUser__Authorization___ResetPasswordByLastStep___Result = Result<UnifiedReport<Void, ApplicationUser__Authorization___ResetPasswordByLastStep___Precedent>>;
...
ApplicationUser__Authorization___CheckNicknameForExisting___Result *application_user___authorization____check_nickname_for_existing____deserialize(Vector *vector);
...
ApplicationUser__Authorization___DeauthorizeFromAllDevices___Result *application_user___authorization____deauthorize_from_all_devices____deserialize(Vector *vector);
...
ApplicationUser__Authorization___DeauthorizeFromOneDevice___Result *application_user___authorization____deauthorize_from_one_device____deserialize(Vector *vector);
...
ApplicationUser__Authorization___RefreshAccessToken___Result *application_user___authorization____refresh_access_token____deserialize(Vector *vector);
...
ApplicationUser__Authorization___RegisterByFirstStep___Result *application_user___authorization____register_by_first_step____deserialize(Vector *vector);
...
ApplicationUser__Authorization___RegisterBySecondStep___Result *application_user___authorization____register_by_second_step____deserialize(Vector *vector);
...
ApplicationUser__Authorization___RegisterByLastStep___Result *application_user___authorization____register_by_last_step____deserialize(Vector *vector);
...
ApplicationUser__Authorization___ResetPasswordByFirstStep___Result *application_user___authorization____reset_password_by_first_step____deserialize(Vector *vector);
...
ApplicationUser__Authorization___ResetPasswordBySecondStep___Result *application_user___authorization____reset_password_by_second_step____deserialize(Vector *vector);
...
ApplicationUser__Authorization___ResetPasswordByLastStep___Result *application_user___authorization____reset_password_by_last_step____deserialize(Vector *vector);
