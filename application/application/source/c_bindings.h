...
using Channel__Base___GetManyBySubscription___Result = C_Result<C_UnifiedReport<Channel__Base___GetManyBySubscription___Outcoming, Channel__Base___GetManyBySubscription___Precedent>>;
...
ApplicationUser__Authorization___AuthorizeByFirstStep___Result *application_user___authorization____authorize_by_first_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___AuthorizeByLastStep___Result *application_user___authorization____authorize_by_last_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___CheckEmailForExisting___Result *application_user___authorization____check_email_for_existing____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___CheckNicknameForExisting___Result *application_user___authorization____check_nickname_for_existing____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___DeauthorizeFromAllDevices___Result *application_user___authorization____deauthorize_from_all_devices____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___DeauthorizeFromOneDevice___Result *application_user___authorization____deauthorize_from_one_device____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___RefreshAccessToken___Result *application_user___authorization____refresh_access_token____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___RegisterByFirstStep___Result *application_user___authorization____register_by_first_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___RegisterBySecondStep___Result *application_user___authorization____register_by_second_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___RegisterByLastStep___Result *application_user___authorization____register_by_last_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___ResetPasswordByFirstStep___Result *application_user___authorization____reset_password_by_first_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___ResetPasswordBySecondStep___Result *application_user___authorization____reset_password_by_second_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___ResetPasswordByLastStep___Result *application_user___authorization____reset_password_by_last_step____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___SendEmailForRegister___Result *application_user___authorization____send_email_for_register____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___SendEmailForAuthorize___Result *application_user___authorization____send_email_for_authorize____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
ApplicationUser__Authorization___SendEmailForResetPassword___Result *application_user___authorization____send_email_for_reset_password____deserialize(C_Vector<unsigned char> *vector_of_bytes);
...
Channel__Base___GetManyByNameInSubscriptions___Result *channel___base____get_many_by_name_in_subscriptions____deserialize(C_Vector<unsigned char> *vector_of_bytes);

void channel___base____get_many_by_name_in_subscriptions____deallocate(Channel__Base___GetManyByNameInSubscriptions___Result *result);
...
Channel__Base___GetManyPublicByName___Result *channel___base____get_many_public_by_name____deserialize(C_Vector<unsigned char> *vector_of_bytes);
