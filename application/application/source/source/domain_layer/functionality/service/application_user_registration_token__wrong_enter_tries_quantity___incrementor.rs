...
impl Incrementor<ApplicationUserRegistrationToken_WrongEnterTriesQuantity> {
    pub fn increment<'a>(application_user_registration_token_wrong_enter_tries_quantity: &'a mut ApplicationUserRegistrationToken_WrongEnterTriesQuantity) -> Result<(), ErrorAuditor_> {
