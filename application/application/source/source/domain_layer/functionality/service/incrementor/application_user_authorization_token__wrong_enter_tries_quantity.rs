...
impl Incrementor<ApplicationUserAuthorizationToken_WrongEnterTriesQuantity> {
    pub fn increment<'a>(application_user_authorization_token_wrong_enter_tries_quantity: &'a mut ApplicationUserAuthorizationToken_WrongEnterTriesQuantity) -> Result<(), ErrorAuditor_> {
