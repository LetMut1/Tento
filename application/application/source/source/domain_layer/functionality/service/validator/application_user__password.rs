...
impl Validator<ApplicationUser_Password> {
    pub fn is_valid<'a>(application_user_password: &'a str, application_user_email: &'a str, application_user_nickname: &'a str) -> bool {
    ...
    pub fn is_valid_part_2<'a>(application_user_password: &'a str, application_user_email: &'a str, application_user_nickname: &'a str) -> bool {
