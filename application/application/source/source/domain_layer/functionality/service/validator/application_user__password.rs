...
impl Validator<ApplicationUser_Password> {
    pub fn is_valid<'a>(application_user_password: &'a str, application_user__email: &'a str, application_user__nickname: &'a str) -> bool {
    ...
    pub fn is_valid_part_2<'a>(application_user_password: &'a str, application_user__email: &'a str, application_user__nickname: &'a str) -> bool {
        return application_user_password != application_user__email && application_user_password != application_user__nickname;
    }
}
