...
// pub struct CreatedAt; что это?

// перенести константы из валидатора в newType поля сушности.


// enum ApplicationUser_Aggregator {  и подобные заменить просто на тапл необходимых полей.

//  в репозиториях делать референс без промежуточного копирования Copy типов.
