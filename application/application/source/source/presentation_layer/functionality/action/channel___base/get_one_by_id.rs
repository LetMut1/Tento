pub use crate::application_layer::functionality::action_processor::channel___base::get_one_by_id::Channel__Base___GetOneById;
...
impl Action<Channel__Base___GetOneById> {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<GeneralizedAction>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<Channel__Base___GetOneById>::process,
        )
        .await;
    }
}
