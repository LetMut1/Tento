...
pub use crate::application_layer::functionality::action_processor::application_user___authorization::send_email_for_authorize::ApplicationUser__Authorization___SendEmailForAuthorize;

#[cfg(feature = "manual_testing")]
use crate::infrastructure_layer::functionality::service::serializer::Json;

impl Action<ApplicationUser__Authorization___SendEmailForAuthorize> {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<GeneralizedAction>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<ApplicationUser__Authorization___SendEmailForAuthorize>::process,
        )
        .await;
    }
}
