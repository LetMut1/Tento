use crate::application_layer::functionality::action_processor::application_user___authorization::authorize_by_first_step::ApplicationUser__Authorization___AuthorizeByFirstStep as AuthorizeByFirstStep_;
...
impl AuthorizeByFirstStep {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<Action>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<AuthorizeByFirstStep_>::process,
        )
        .await;
    }
}
