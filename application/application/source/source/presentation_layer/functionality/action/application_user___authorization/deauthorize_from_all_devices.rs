use crate::application_layer::functionality::action_processor::application_user___authorization::deauthorize_from_all_devices::ApplicationUser__Authorization___DeauthorizeFromAllDevices as DeauthorizeFromAllDevices_;
...
impl DeauthorizeFromAllDevices {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<Action>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<DeauthorizeFromAllDevices_>::process,
        )
        .await;
    }
}
