pub use crate::application_layer::functionality::action_processor::application_user___authorization::deauthorize_from_all_devices::ApplicationUser__Authorization___DeauthorizeFromAllDevices;
...
impl Action<ApplicationUser__Authorization___DeauthorizeFromAllDevices> {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<GeneralizedAction>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<ApplicationUser__Authorization___DeauthorizeFromAllDevices>::process,
        )
        .await;
    }
}
