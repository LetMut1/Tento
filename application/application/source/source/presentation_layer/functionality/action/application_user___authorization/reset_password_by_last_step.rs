pub use crate::application_layer::functionality::action_processor::application_user___authorization::reset_password_by_last_step::ApplicationUser__Authorization___ResetPasswordByLastStep;
...
impl Action<ApplicationUser__Authorization___ResetPasswordByLastStep> {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<GeneralizedAction>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<ApplicationUser__Authorization___ResetPasswordByLastStep>::process,
        )
        .await;
    }
}
