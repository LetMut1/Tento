use crate::application_layer::functionality::action_processor::application_user___authorization::reset_password_by_last_step::ApplicationUser__Authorization___ResetPasswordByLastStep as ResetPasswordByLastStep_;
...
impl ResetPasswordByLastStep {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<Action>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<ResetPasswordByLastStep_>::process,
        )
        .await;
    }
}
