...
impl Action<ApplicationUser__Authorization___CheckNicknameForExisting> {
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        return Processor::<ActionRound>::process::<'_, '_, '_, _, _, _, _, _, _, _, _, MessagePack>(
            ...
            ActionProcessor::<ApplicationUser__Authorization___CheckNicknameForExisting>::process,
        )
        .await;
    }
}
