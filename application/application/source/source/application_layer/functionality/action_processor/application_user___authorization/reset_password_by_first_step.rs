...
use crate::infrastructure_layer::functionality::repository::postgresql::insert::Insert6;
use crate::infrastructure_layer::functionality::repository::postgresql::update::Update12;
use crate::infrastructure_layer::functionality::repository::postgresql::update::Update13;
use crate::infrastructure_layer::functionality::repository::postgresql::update::Update14;
        ...
        <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send,
    {
        ...
        .await?
        {
            Some(mut application_user_reset_password_token) => {
                let (can_send_, need_to_update_1) = if ExpirationTimeChecker::<UnixTime>::is_expired(application_user_reset_password_token.can_be_resent_from.0) {
                ...
                let need_to_update_2 = if ExpirationTimeChecker::<UnixTime>::is_expired(application_user_reset_password_token.expires_at.0) || application_user_reset_password_token.is_approved.0 {
                    ...
                    application_user_reset_password_token.wrong_enter_tries_quantity = ApplicationUserResetPasswordToken_WrongEnterTriesQuantity(0);
