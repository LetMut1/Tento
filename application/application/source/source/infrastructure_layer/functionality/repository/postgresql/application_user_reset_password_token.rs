...
impl PostgresqlRepository<ApplicationUserResetPasswordToken<'_>> {
    pub async fn create_1<'a>(database_2_connection: &'a Connection, insert_1: Insert1<'a>) -> Result<ApplicationUserResetPasswordToken<'a>, AggregateError> {
        ...
        prepared_statemant_parameter_convertation_resolver
            ...
            .add_parameter(
                &insert_1.application_user_reset_password_token__expires_at,
                Type::INT8,
            )
            .add_parameter(
                &insert_1.application_user_reset_password_token__can_be_resent_from,
                Type::INT8,
            );
    ...
    pub async fn delete_2<'a>(database_2_connection: &'a Connection, by_1: By1<'_>) -> Result<(), AggregateError> {
        let mut prepared_statemant_parameter_convertation_resolver = PreparedStatementParameterConvertationResolver::new();
        let query = "\
    ...
    pub async fn update_1<'a>(database_2_connection: &'a Connection, update_1: Update1<'_>, by_1: By1<'_>) -> Result<(), AggregateError> {
        ...
        prepared_statemant_parameter_convertation_resolver
            ...
            .add_parameter(
                &update_1.application_user_reset_password_token__wrong_enter_tries_quantity,
                Type::INT2,
            )
            .add_parameter(
                &update_1.application_user_reset_password_token__is_approved,
                Type::BOOL,
            )
            .add_parameter(
                &update_1.application_user_reset_password_token__expires_at,
                Type::INT8,
            )
            .add_parameter(
                &update_1.application_user_reset_password_token__can_be_resent_from,
                Type::INT8,
            )
            .add_parameter(
                &by_1.application_user__id,
    ...
    pub async fn update_2<'a>(database_2_connection: &'a Connection, update_2: Update2, by_1: By1<'_>) -> Result<(), AggregateError> {
        let mut prepared_statemant_parameter_convertation_resolver = PreparedStatementParameterConvertationResolver::new();
        let query = "\
            UPDATE ONLY public.application_user_reset_password_token AS aurpt
            SET ( \
    ...
    pub async fn update_3<'a>(database_2_connection: &'a Connection, update_3: Update3<'_>, by_1: By1<'_>) -> Result<(), AggregateError> {
        let mut prepared_statemant_parameter_convertation_resolver = PreparedStatementParameterConvertationResolver::new();
        let query = "\
            UPDATE ONLY public.application_user_reset_password_token AS aurpt
            SET ( \
        ...
        prepared_statemant_parameter_convertation_resolver
            ...
            .add_parameter(
                &update_3.application_user_reset_password_token__wrong_enter_tries_quantity,
                Type::INT2,
            )
            .add_parameter(
                &update_3.application_user_reset_password_token__is_approved,
                Type::BOOL,
            )
            .add_parameter(
                &update_3.application_user_reset_password_token__expires_at,
                Type::INT8,
            )
            .add_parameter(
                &by_1.application_user__id,
    ...
    pub async fn update_5<'a>(database_2_connection: &'a Connection, update_5: Update5, by_1: By1<'_>) -> Result<(), AggregateError> {
        let mut prepared_statemant_parameter_convertation_resolver = PreparedStatementParameterConvertationResolver::new();
        let query = "\
            UPDATE ONLY public.application_user_reset_password_token AS aurpt
            SET ( \
    ...
    pub async fn find_1<'a>(database_2_connection: &'a Connection, by_1: By1<'_>) -> Result<Option<ApplicationUserResetPasswordToken1>, AggregateError> {
        let mut prepared_statemant_parameter_convertation_resolver = PreparedStatementParameterConvertationResolver::new();
        let query = "\
            SELECT \
                aurpt.value AS v, \
    ...
    pub async fn find_2<'a>(database_2_connection: &'a Connection, by_1: By1<'_>) -> Result<Option<ApplicationUserResetPasswordToken2>, AggregateError> {
        let mut prepared_statemant_parameter_convertation_resolver = PreparedStatementParameterConvertationResolver::new();
        let query = "\
            SELECT \
                aurpt.value AS v, \
    ...
    pub async fn find_3<'a>(database_2_connection: &'a Connection, by_1: By1<'_>) -> Result<Option<ApplicationUserResetPasswordToken3>, AggregateError> {
        let mut prepared_statemant_parameter_convertation_resolver = PreparedStatementParameterConvertationResolver::new();
        let query = "\
            SELECT \
                aurpt.value AS v, \
...
pub struct Insert1<'a> {
    ...
    pub application_user_reset_password_token__expires_at: i64,
    pub application_user_reset_password_token__can_be_resent_from: i64,
}
pub struct Update1<'a> {
    pub application_user_reset_password_token__value: &'a str,
    pub application_user_reset_password_token__wrong_enter_tries_quantity: i16,
    pub application_user_reset_password_token__is_approved: bool,
    pub application_user_reset_password_token__expires_at: i64,
    pub application_user_reset_password_token__can_be_resent_from: i64,
