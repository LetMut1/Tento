...
impl PostgresqlRepository<ApplicationUserRegistrationToken<'_>> {
    ...
    pub async fn delete_2<'a>(
        ...
        prepared_statemant_parameter_convertation_resolver.add_parameter(&by_1.application_user_email, Type::TEXT).add_parameter(&by_1.application_user_device_id, Type::TEXT);
