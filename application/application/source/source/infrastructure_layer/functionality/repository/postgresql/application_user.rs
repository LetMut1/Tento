...
impl PostgresqlRepository<ApplicationUser<'_>> {
        ...
        return Ok(
            Some(
                ApplicationUser::new(
                    ...
                    row_registry[0].try_get::<'_, usize, String>(3).into_invalid_argument_from_client_code(
                        Backtrace::new(
                            line!(),
                            file!(),
                        ),
    ...
    pub async fn find_2<'a>(database_1_connection: &'a Connection, by_1: By1<'_>) -> Result<Option<ApplicationUser1>, AggregateError> {
        ...
        return Ok(
            Some(
                ApplicationUser1 {
                    id: row_registry[0].try_get::<'_, usize, i64>(0).into_invalid_argument_from_client_code(
                        Backtrace::new(
                            line!(),
                            file!(),
                        ),
                    )?,
                    email: row_registry[0].try_get::<'_, usize, String>(1).into_invalid_argument_from_client_code(
                        Backtrace::new(
                            line!(),
                            file!(),
                        ),
                    )?,
                    password_hash: row_registry[0].try_get::<'_, usize, String>(2).into_invalid_argument_from_client_code(
                        Backtrace::new(
                            line!(),
                            file!(),
                        ),
        ...
        return Ok(
            Some(
                ApplicationUser2 {
                    ...
                    nickname: row_registry[0].try_get::<'_, usize, String>(1).into_invalid_argument_from_client_code(
                        Backtrace::new(
                            line!(),
                            file!(),
                        ),
    ...
    pub async fn find_5<'a>(database_1_connection: &'a Connection, by_3: By3) -> Result<Option<ApplicationUser4>, AggregateError> {
        ...
        return Ok(
            Some(
                ApplicationUser4 {
                    email: row_registry[0].try_get::<'_, usize, String>(0).into_invalid_argument_from_client_code(
                        Backtrace::new(
                            line!(),
                            file!(),
                        ),
