...
impl PostgresqlRepository<ApplicationUser<'_>> {
    ...
    pub async fn update_1<'a>(
        ...
        prepared_statemant_parameter_convertation_resolver.add_parameter(&update_1.application_user_password_hash, Type::TEXT).add_parameter(&by_3.application_user_id, Type::INT8);
