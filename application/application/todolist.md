...
ResultConverter - имплементировать для одного типа без трэйт боунда СТдЕррор? Если так, то нужно ли убрать "std" фичу у Argone2 крейта.

 ОБНОВИТЬ КРеЙты на новые.
...
-> impl Future<> _______+ 'static______нужно ли, или там автоматически?