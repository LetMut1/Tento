...
USING btree (application_user_id, id ASC NULLS LAST) WITH (fillfactor = 90, deduplicate_items = on);
...
ADD CONSTRAINT application_user_device3 FOREIGN KEY (application_user_id)
