...
impl EnvironmentConfigurationResolver {
    ...
    pub const RESOURCE_AUTHORIZATION_POSTGRESQL_URL_KEY: &'static str = "RESOURCE_AUTHORIZAYION_POSTGRESQL_URL";
    ...
    pub fn get_resource_authorization_postgresql_configuration<'a>(&'a self) -> &'a Config {
        return &self.resource_authorization_postgresql_configuration;
    }
