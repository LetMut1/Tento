...
impl PostgresqlRepository<ApplicationUserResetPasswordToken_1> {
        ...
        T: Getter<'a, ApplicationUserResetPasswordToken_CanBeResentFrom>,
    {
        ...
        let application_user_reset_password_token_value =
            <T as Getter<'a, &'a ApplicationUserResetPasswordToken_Value>>::get(subject).get();

        let application_user_reset_password_token_wrong_enter_tries_quantity =
            <T as Getter<'a, ApplicationUserResetPasswordToken_WrongEnterTriesQuantity>>::get(subject).get();

        let application_user_reset_password_token_is_approved =
            <T as Getter<'a, ApplicationUserResetPasswordToken_IsApproved>>::get(subject).get();

        let application_user_reset_password_token_expires_at =
            <T as Getter<'a, ApplicationUserResetPasswordToken_ExpiresAt>>::get(subject).get();

        let application_user_reset_password_token_can_be_resent_from =
            <T as Getter<'a, ApplicationUserResetPasswordToken_CanBeResentFrom>>::get(subject).get();
    ...
    pub async fn find_1<'a>(
        ...
        let application_user_reset_password_token_value = match row_registry[0].try_get::<'_, usize, String>(0) {
            Ok(application_user_reset_password_token_value_) => {
                ApplicationUserResetPasswordToken_Value::new(application_user_reset_password_token_value_)
            }
            Err(error) => {
                return Err(
                    ErrorAuditor::new(
        ...
        let application_user_reset_password_token_wrong_enter_tries_quantity =
            match row_registry[0].try_get::<'_, usize, i16>(1) {
                Ok(application_user_reset_password_token_wrong_enter_tries_quantity_) => {
        ...
        let application_user_reset_password_token_is_approved = match row_registry[0].try_get::<'_, usize, bool>(2) {
            Ok(application_user_reset_password_token_is_approved_) => {
                ApplicationUserResetPasswordToken_IsApproved::new(application_user_reset_password_token_is_approved_)
            }
            Err(error) => {
                return Err(
                    ErrorAuditor::new(
        ...
        let application_user_reset_password_token_expires_at = match row_registry[0].try_get::<'_, usize, i64>(3) {
            Ok(application_user_reset_password_token_expires_at_) => {
                ApplicationUserResetPasswordToken_ExpiresAt::new(application_user_reset_password_token_expires_at_)
            }
            Err(error) => {
                return Err(
                    ErrorAuditor::new(
        ...
        let application_user_reset_password_token_can_be_resent_from =
            match row_registry[0].try_get::<'_, usize, i64>(4) {
                Ok(application_user_reset_password_token_can_be_resent_from_) => {
                    ApplicationUserResetPasswordToken_CanBeResentFrom::new(
...
impl PostgresqlRepository<ApplicationUserResetPasswordToken_6> {
    pub async fn find_1<'a>(
        ...
        let application_user_reset_password_token_can_be_resent_from =
            match row_registry[0].try_get::<'_, usize, i64>(3) {
                Ok(application_user_reset_password_token_can_be_resent_from_) => {
                    ApplicationUserResetPasswordToken_CanBeResentFrom::new(
                        application_user_reset_password_token_can_be_resent_from_,
                    )
...
pub struct Insert<'a> {
    ...
    pub application_user_reset_password_token_wrong_enter_tries_quantity:
