...
impl StorageKeyResolver {
    ...
    pub fn get_repository_application_user_pre_confirmed_first<'a>(
        application_user_email: &'a str
    ) -> &'a str {
        return application_user_email;
    }

    pub fn get_repository_application_user_registration_confirmation_token_first<'a>(
        application_user_email: &'a str
    ) -> String {
        return Self::PREFIX_REPOSITORY_APPLICATION_USER_REGISTRATION_CONFIRMATION_TOKEN_FIRST.to_string() + application_user_email;
    }
