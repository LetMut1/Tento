...
impl CommunicationCodeRegistry {
    /// Codes for ApplicationUser context.
    /// [0, 999]
    ...
    /// Codes for ApplicationUserRegistrationToken context.
    /// [1000, 1999]
    ...
    /// Codes for ApplicationUserAuthorizationToken context.
    /// [2000, 2999]
    ...
    /// Codes for ApplicationUserResetPasswordToken context.
    /// [3000, 3999]
    ...
    pub const APPLICATION_USER_RESET_PASSWORD_TOKEN__TIME_TO_RESEND_HAS_NOT_COME: i64 = 3005;

    /// Codes for ApplicationUserAccessToken context.
    /// [4000, 4999]
    ...
    /// Codes for ApplicationUserAccessRefreshToken context.
    /// [5000, 5999]
