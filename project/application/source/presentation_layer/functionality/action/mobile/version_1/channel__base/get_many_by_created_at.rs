...
use crate::application_layer::functionality::service::action_processor::channel__base::get_many_by_created_at::Outcoming;
#[cfg(feature = "facilitate_non_automatic_functional_testing")]
...
#[cfg(feature = "facilitate_non_automatic_functional_testing")]
pub async fn get_many_by_created_at_<'a, T>(
    environment_configuration: &'a EnvironmentConfiguration,
