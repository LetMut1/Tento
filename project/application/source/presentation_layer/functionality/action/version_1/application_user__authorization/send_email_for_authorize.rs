...
use crate::application_layer::functionality::action_processor::application_user__authorization::send_email_for_authorize::ActionProcessor;
use crate::application_layer::functionality::action_processor::application_user__authorization::send_email_for_authorize::Incoming;
use crate::application_layer::functionality::action_processor::application_user__authorization::send_email_for_authorize::Outcoming;
        ...
        match action_processor_result {
            ...
            ActionProcessorResult::UserWorkflowPrecedent { user_workflow_precedent } => {
                match user_workflow_precedent {
                    ...
                    UserWorkflowPrecedent::ApplicationUserAuthorizationToken_NotFound => {
                        return Ok(
                            UnifiedReport::communication_code(
                    ...
                    UserWorkflowPrecedent::ApplicationUserAuthorizationToken_AlreadyExpired => {
                        return Ok(
                            UnifiedReport::communication_code(
                    ...
                    UserWorkflowPrecedent::ApplicationUserAuthorizationToken_TimeToResendHasNotCome => {
                        return Ok(
                            UnifiedReport::communication_code(
