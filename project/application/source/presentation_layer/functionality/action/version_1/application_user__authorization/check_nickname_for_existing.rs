...
use crate::application_layer::functionality::service::action_inner_processor::application_user__authorization::check_nickname_for_existing::ActionProcessor;
use crate::application_layer::functionality::service::action_inner_processor::application_user__authorization::check_nickname_for_existing::Incoming;
...
use crate::application_layer::functionality::service::action_inner_processor::application_user__authorization::check_nickname_for_existing::Outcoming;
#[cfg(feature = "facilitate_non_automatic_functional_testing")]
    ...
    <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send
{
    ...
    let action_processor_result = match ActionProcessor::process(
        database_1_postgresql_connection_pool, incoming
    ).await {
