...
use crate::application_layer::functionality::service::action_inner_processor::channel__base::get_many_public_by_name::Outcoming;
#[cfg(feature = "facilitate_non_automatic_functional_testing")]
...
pub async fn get_many_public_by_name<'a, T>(
...
#[cfg(feature = "facilitate_non_automatic_functional_testing")]
pub async fn get_many_public_by_name_<'a, T>(
    environment_configuration: &'a EnvironmentConfiguration,
