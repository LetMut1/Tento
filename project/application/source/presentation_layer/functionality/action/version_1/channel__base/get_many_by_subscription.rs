...
use crate::application_layer::functionality::service::action_inner_processor::channel__base::get_many_by_subscription::ActionProcessor;
use crate::application_layer::functionality::service::action_inner_processor::channel__base::get_many_by_subscription::Incoming;
...
use crate::application_layer::functionality::service::action_inner_processor::channel__base::get_many_by_subscription::Outcoming;
#[cfg(feature = "facilitate_non_automatic_functional_testing")]
...
pub async fn get_many_by_subscription<'a, T>(
...
#[cfg(feature = "facilitate_non_automatic_functional_testing")]
pub async fn get_many_by_subscription_<'a, T>(
    environment_configuration: &'a EnvironmentConfiguration,
