...
use crate::application_layer::functionality::service::action_processor::channel_subscription__base::create::ActionProcessor;
use crate::application_layer::functionality::service::action_processor::channel_subscription__base::create::Incoming;
    ...
    <<T as MakeTlsConnect<Socket>>::TlsConnect as TlsConnect<Socket>>::Future: Send
{
    ...
    match action_processor_result_ {
        ActionProcessorResult::Void => {
            let data = match MessagePackSerializer::serialize(&UnifiedReport::<Void>::empty()) {
                Ok(data_) => data_,
                Err(error) => {
                    let response = ActionResponseCreator::create_internal_server_error();
