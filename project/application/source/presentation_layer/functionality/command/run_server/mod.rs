...
// имплементировать структуру с фантомной датой в файле с названием сущности имплементации. То есть, есть PostgresqlRepository, но имплементация для ApplicationUser будет в ApplUser_PosRepository. И там сделать для каждой функуиональности.
