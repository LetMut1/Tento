...
// логи писать в БазуДанных, (КЛИК хАУС или подобные). Возможно сразу туда, где токены. Сначала сделать просто запись в лог любого любого события. если логи писать в бд токенов, то базу данных переназвать.

// TODO TODO TODO TODO СДелать интервал, когда можео менять аксесс токен. На 3 часа раньше, чем срок экспирации, например
