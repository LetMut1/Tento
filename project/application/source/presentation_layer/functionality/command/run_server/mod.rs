...
// убрать копирование при инъекции зависимости. // env поменять на другой формат, чтобы не было глобальног считывания.// source -> в название. Где должен быть екстернкрэйт?