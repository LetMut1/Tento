...
use crate::application_layer::data_transfer_object::response_data::_in_context_for::application_layer::service::action_handler::_in_context_for::presentation_layer::service::controller::mobile::version_1::_in_context_for::domain_layer::entity::application_user::_new_for_context::authorization::_new_for_context::log_out_from_all_devices_::base::_new_for_context::base::Base as ResponseData;
...
impl Base {
    pub async fn handle<'a>(
        ...
        let response = Authorization::log_out_from_all_devices(environment_configuration_resolver, request, redis_connection_pool).await;
