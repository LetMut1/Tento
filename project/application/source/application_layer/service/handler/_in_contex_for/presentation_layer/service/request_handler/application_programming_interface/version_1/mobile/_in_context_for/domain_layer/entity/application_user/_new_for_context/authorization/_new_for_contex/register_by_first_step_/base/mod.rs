...
use crate::presentation_layer::data_transfer_object::request_data::_in_context_for::presentation_layer::service::request_handler::application_programming_interface::version_1::mobile::_in_context_for::domain_layer::entity::application_user::_new_for_context::authorization::_new_for_context::register_by_first_step::base::Base as RequestData;
...
impl Base {
    pub async fn handle(
    ...
    ) -> Result<(Option<WrappedResponseData<()>>, ResponseParts), BaseError> {
        ...
        let result: (Option<WrappedResponseData<()>>, ResponseParts);
