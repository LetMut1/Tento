...
impl Base {
    ...
    pub fn handle(
        ...
        let channel_registry: Option<Vec<Channel>> = ChannelDataProviderPostgresql::per_request_4(
            &mut *ConnectionExtractorXXXxDelete::get_postgresql_connection(&aggregate_connection_pool)?, &channel_id_registry_
        )?;
