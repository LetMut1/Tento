...
use crate::presentation_layer::data_transfer_object::request_data::_in_context_for::presentation_layer::service::request_handler::application_programming_interface::version_1::mobile::_in_context_for::domain_layer::entity::application_user::_new_for_context::authorization::_new_for_context::log_out_from_all_devices_::base::Base as RequestData;
...
impl Base {
    pub async fn handle(
        ...
        let response = Authorization::log_out_from_all_devices(request_data.into_inner(), redis_connection_pool).await;
