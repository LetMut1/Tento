...
impl<T> ActionProcessorResult<T> {
    ...
    pub fn application_user__workflow_exception(
        application_user__workflow_exception: ApplicationUser_WorkflowException
    ) -> Self {
        return Self::EntityWorkflowException {
            entity_workflow_exception: EntityWorkflowException::ApplicationUser { application_user__workflow_exception }
        };
    }
    ...
    #[allow(non_snake_case)]
    pub fn application_user_reset_password_token__workflow_exception(
        application_user_reset_password_token__workflow_exception: ApplicationUserResetPasswordToken_WorkflowException
    ) -> Self {
        return Self::EntityWorkflowException {
            entity_workflow_exception: EntityWorkflowException::ApplicationUserResetPasswordToken {
                application_user_reset_password_token__workflow_exception
            }
        };
    }

    #[allow(non_snake_case)]
    pub fn application_user_access_token__workflow_exception(
        application_user_access_token__workflow_exception: ApplicationUserAccessToken_WorkflowException
    ) -> Self {
        return Self::EntityWorkflowException {
            entity_workflow_exception: EntityWorkflowException::ApplicationUserAccessToken { application_user_access_token__workflow_exception }
        };
    }

    #[allow(non_snake_case)]
    pub fn application_user_access_refresh_token__workflow_exception(
        application_user_access_refresh_token__workflow_exception: ApplicationUserAccessRefreshToken_WorkflowException
    ) -> Self {
        return Self::EntityWorkflowException {
            entity_workflow_exception: EntityWorkflowException::ApplicationUserAccessRefreshToken {
                application_user_access_refresh_token__workflow_exception
            }
        };
    }
}