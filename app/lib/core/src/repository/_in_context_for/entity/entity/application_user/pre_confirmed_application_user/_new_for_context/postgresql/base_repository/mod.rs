...
impl<'outer> BaseRepository {
    ...
    pub fn is_exist_by_email(connection_manager: &'outer ConnectionManager, email: &'outer str) -> Result<bool, DieselError> { // TODO сделать возможномть устанавливать фильтр ? 
    ...
    pub fn get_by_email(connection_manager: &'outer ConnectionManager, email: &'outer str) -> Result<Option<PreConfirmedApplicationUser>, DieselError> {
