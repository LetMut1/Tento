...
impl<'b> BaseRepository {
    ...
    pub fn is_exist_by_nickanme(pg_connection_manager: &'b PgConnection, nickname: &'b String) -> bool { // TODO сделать возможномть устанавливать фильтр ?
        return 
    ...
    pub fn get_by_email(pg_connection_manager: &'b PgConnection, email: &'b String) -> Existing {
        return 
