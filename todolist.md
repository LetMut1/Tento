...
Прецеденты в ffi должны иметь 3 _, а не 2. user__not_found - неправильно, но user___not_found - правильно.
------------------------------------------------------------------------------------------------------------------------------------

Сделать факт наличия через токен.
рефреш токена ?
подписка на канал ?
лайк - сделано

Убрать ненужную проверку на существование и сделать через скл-конфликт с количеством строк.
Для массовых постоянных действий:
рефреш токена ?
подписка на канал ?
лайк - сделано


Доделать механизм удаления через флаг и время жизни токенов. СРазу написать команду с отдельными конфигами.
Доделать для Лайков. Затем перейти к другим уже сущетвующим токенам.
