...
создавать и удалять Лимитер при создании и удалении Юзера.
как сделать консистентность?
1. Создавать Лимитер при создании юзера - это 3 разных бд, где нужна консистентность  (https://www.reddit.com/r/golang/comments/147uc6v/how_did_you_solve_the_problem_of_transactions/?rdt=47234) (Можно создать таблицу с Таксами на 3 необходимые инсерта и делать все в параллельном таске и обновлять ее только)
2. Создавать Лимитер при создании канала со значением 1. При удалении каналов в 0 оставлять или удалять Лимитер. - здесь все будет консистентно.
Наверное, лучше сделать 2 вариант, потому что обеспечивать консистентность на 3 бд намного сложнее