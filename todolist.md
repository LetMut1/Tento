...
Остановился на обраьотке буул из репозитриев на Repository::<Postgresql<Channel>>::update_1( (в Репозитории дерикториях идти выше)


CreatedInParallelExecution + DeletedInParallelExecution  -> ParallelExecution