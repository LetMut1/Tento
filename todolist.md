...
Возможно ли прийти к тому, что большинство данных, которые нужны для проверки (экзист и файнд в Репозитории) получать через токены?
...
Доделать механизм удаления через флаг и время жизни токенов.