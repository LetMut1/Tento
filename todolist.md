...
channel_publication1__id: i64 вставить в channel_publication1_token_signed: ChannelPublication1TokenSigned, чтобы токен использовался не просто как доказательство, но и как база данных
Затем убрать channel_publication1__id из инкомингов и оуткомингов там, где есть channel_publication1_token_signed
...
Запросы, где апдейт на инкриз-дикриз сделать через enum EncreDEcr