...
В репозиториях, где есть Returning в Скл, проверять на количество вернувшихся строк и отдавать АнричСтейт ошибку - это лучше, чем поймать Панику при обращении к 0 элементу rows


В ffi модуле нет 3 апи для channel